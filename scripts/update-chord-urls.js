...
/**
 * Script to update existing chord_positions records with correct AWS S3 URLs
 */

async function updateChordUrls() {
  try {
    console.log('🚀 Updating chord position URLs...')
    ...
    for (const position of positions) {
      ...
      const newLightUrl = `https://guitarmagic-chord-library.s3.us-west-2.amazonaws.com/${position.chord_position_full_name}_light.png`
      const newDarkUrl = `https://guitarmagic-chord-library.s3.us-west-2.amazonaws.com/${position.chord_position_full_name}_dark.png`
    ...
    console.log(`🎉 Successfully updated ${updatedCount} chord positions!`)
